...
insert into tb_produto(nome, preco, estoque, cor, segmento, categoria_id) values("manta termica", 65.00, true, "preto", "construção civil;", 5);
insert into tb_produto(nome, preco, estoque, cor, segmento, categoria_id) values("Cano de tubulação", 15.00, true, "branco", "construção civil.", 1);
...
insert into tb_produto(nome, preco, estoque, cor, segmento, categoria_id) values("Piso ", 26.99, false, "madeira", "construção civil", 3);
insert into tb_produto(nome, preco, estoque, cor, segmento, categoria_id) values("Torneira", 102.99, true, "prata", "construção civil", 1); 
insert into tb_produto(nome, preco, estoque, cor, segmento, categoria_id) values("Piso porcelana", 57.99, true, "diversos", "construção civil", 3);
