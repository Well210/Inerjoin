...
insert into tb_produto(nome, preco, estoque, conservarEm, beneficios, categoria_id) values("Abobora", 52.50, true, "convervar em local fresco", "Fonte de vitamina B1, atua no bom funcionamento do sistema nervoso. A semente também é rica em gorduras boas e tem efeito calmante", 5);
insert into tb_produto(nome, preco, estoque, conservarEm, beneficios, categoria_id) values("Limao", 6.99, false, "conversar em geladeira", "Protege os vasos sanguíneos.", 2);
